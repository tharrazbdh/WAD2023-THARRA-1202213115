<?php
if (isset($_POST['tinggi_badan']) && isset($_POST['tinggi_badan'])) {
...
// silakan taruh code kalian di bawah
    if ($tinggi_badan == null || $berat_badan == null) {
        $tinggi_error = "nilai tinggi badan tidak boleh kosong";
...
// **********************  3  ************************** 
        ...
        $hasiltinggibadan = $tinggi_badan / ($berat_badan ** 3);
    }
}
        ...
        <div class="col-md-4 p-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- silakan taruh code kalian di bawah -->
                    <?php
                        if (isset($hasiltinggibadan)) {
                        echo "Hasil penambahannya adalah:" . $hasiltinggibadan;}
                    ?>
                    <!--  **********************  4  **************************     -->
